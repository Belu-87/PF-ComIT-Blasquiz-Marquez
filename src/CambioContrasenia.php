        ...
        <div class="form-bottom">
            <form role="form" action="javascript:CambioContrasenia();" method="post" class="registration-form">
				<div class="form-group">
                	...
                	<input type="text" name="form-password" class="form-password form-control campo" id="codigo">
                </div>
			
				<div class="form-group">
                	<label class="">Contraseña nueva</label>
                	<input type="password" name="form-password" class="form-password form-control campo" id="newpass">
                </div>
				
				<div class="form-group">
                	<label class="">Confirmar Contraseña</label>
                	<input type="password" name="form-confipassword" class="form-confipassword form-control campo" id="renewpass">
                </div>	
