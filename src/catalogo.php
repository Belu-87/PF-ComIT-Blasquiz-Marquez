...
<div id="canvas">
	<div id="book-zoom">
		<div class="sj-book">
			...
			<div class="hard fixed back-side p27"> <div class="depth"></div> </div>
		...
		when: {
			turning: function(e, page, view) {
				...
				if (page<book.turn('pages'))
					$('.sj-book .p27').addClass('fixed');
				else
					$('.sj-book .p27').removeClass('fixed');
...
yepnope({
	...
	both: ['turnjs4/samples/steve-jobs/js/steve-jobs.js', 'turnjs4/samples/steve-jobs/css/jquery.ui.css', 'turnjs4/samples/steve-jobs/css/steve-jobs.css'],
	complete: loadApp
});
